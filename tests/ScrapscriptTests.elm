    ...
    describe "Scrapscript"
        [ describe "Lexing" <|
            List.map (\( k, v ) -> test k <| \_ -> Expect.equal v (parse k))
                ...
                , ( "[1,2]", Ok (List [ Int 1, Int 2 ]) )
                , ( "a -> b -> a + b", Ok (Function (Var "a") (Function (Var "b") (Binop "+" (Var "a") (Var "b")))) )
                , ( "a->b->a+b", Ok (Function (Var "a") (Function (Var "b") (Binop "+" (Var "a") (Var "b")))) )
                ...
                , ( "( )", Ok Hole )
                , ( "(1+2)", Ok (Binop "+" (Int 1) (Int 2)) )
                , ( "1 |> f . f = a -> a + 1", Ok (Binop "|>" (Int 1) (Binop "." (Var "f") (Binop "=" (Var "f") (Function (Var "a") (Binop "+" (Var "a") (Int 1)))))) )
                , ( "f <| 1 . f = a -> a + 1", Ok (Binop "<|" (Var "f") (Binop "." (Int 1) (Binop "=" (Var "f") (Function (Var "a") (Binop "+" (Var "a") (Int 1)))))) )
        ...
        , describe "Parsing" <|
            List.map (\( k, v ) -> test k <| always <| Expect.equal v <| parse k)
                ...
                , ( "a -> a + 1", Ok (Function (Var "a") (Binop "+" (Var "a") (Int 1))) )
                , ( "a -> b -> a + b", Ok (Function (Var "a") (Function (Var "b") (Binop "+" (Var "a") (Var "b")))) )
                , ( "id = x -> x", Ok (Binop "=" (Var "id") (Function (Var "x") (Var "x"))) )
                ...
                , ( "| 1 -> 2", Err "TODO" )
                , ( "| 1 -> 2 | 2 -> 3", Err "TODO" )
                , ( "f >> g", Ok (Function (Var "$v0") (Apply (Var "g") (Apply (Var "f") (Var "$v0")))) )
                , ( "f << g", Ok (Function (Var "$v0") (Apply (Var "f") (Apply (Var "g") (Var "$v0")))) )
                , ( "f << g << h", Ok (Function (Var "$v1") (Apply (Var "f") (Apply (Function (Var "$v0") (Apply (Var "g") (Apply (Var "h") (Var "$v0")))) (Var "$v1")))) )
                ...
                {-
                    , (Dict.empty,
                     """
                            ...
                            . f = n -> f
                            """
                   , (Ok (Closure (Dict.singleton "f" (Var "f")) (Function (Var "n") (Var "f"))))
                   )
                -}
                ]
        ]
